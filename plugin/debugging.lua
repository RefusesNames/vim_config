...
vim.keymap.set('n', '<F5>', function() require('dap').continue() end, { desc = 'Run debugger' })
vim.keymap.set('n', '<F10>', function() require('dap').step_over() end, { desc = 'Step over' })
vim.keymap.set('n', '<F11>', function() require('dap').step_into() end, { desc = 'Stop into' })
...
vim.keymap.set('n', '<leader>dr', function() require('dap').repl_open() end, { desc = 'Open REPL' })
